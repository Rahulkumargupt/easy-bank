...
<html lang="en">
<head>
   <title>Easy Bank - Hamara Sath Ap Ka vikash</title>
   <meta charset="utf-8">
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Easy Bank</h1>
      <p1> Easy Bank is a part of Learn Easy Academy foundation. It is one of Iandia's leading private banks and was among the first to receive approval from the Central bank of India (CBI) to set up a private sector bank in 992 ZY.
          Today, Easy Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. Easy Bank offers a diverse range of financial products and banking services to customers(Which are dead actually, because they are EASY) through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<div class="py-5">
 ...
 <p1>This website is the
      ...
      acknowledged within the website. Anyone may reproduce, distribute, adapt, translate the content on the website, without explicit permission, provided that the content is accompanied by an acknowledgement that Easy Bank website is the source and that it is clearly indicated if changes were made to the original content.</p1>
 </div>



<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>Rj Rahul</b> </br>Chairman, Learn Easy Academy</p>
      </footer>
